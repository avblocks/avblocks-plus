...
void setDefaultOptions(Options& opt)
{
    ...
    fs::path output(getExeDir() + "/../../output/dec_vorbis_file");
...
{
    cout << "dec_vorbis_file --input <ogg file> --output <wav file>" << endl;
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    ...
    optcfg.addOptions()
    ("help,h", opt.help, "")
    ("input,i", opt.inputFile, string(), "input Vorbis OGG file")
