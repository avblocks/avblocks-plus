...
{
    opt.inputFile = getExeDir() + "/../../assets/vid/foreman_qcif_vp8.ivf";

    fs::path output(getExeDir() + "/../../output/dec_vp8_file");
...
{
    cout << "Usage: dec_vp8_file --input <vp8 ivf file> --output <yuv file>" << endl;
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    ...
    optcfg.addOptions()
    ("help,h", opt.help, "")
    ("input,i", opt.inputFile, string(), "input VP8 IVF file")
