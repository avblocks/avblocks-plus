...
void setDefaultOptions(Options& opt)
{
    ...
    fs::path output(getExeDir() + L"/../../output/dec_vorbis_file");
...
{
    wcout << L"dec_vorbis_file --input <ogg file> --output <wav file>" << endl;
...
ErrorCodes prepareOptions(Options &opt, int argc, wchar_t* argv[])
{
    ...
    optcfg.addOptions()
    (L"help,h", opt.help, L"")
    (L"input,i", opt.inputFile, wstring(), L"input Vorbis OGG file")
