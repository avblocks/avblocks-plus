...
{
    opt.inputFile = getExeDir() + L"/../../assets/vid/foreman_qcif_vp9.ivf";

    fs::path output(getExeDir() + L"/../../output/dec_vp9_file");
...
{
    wcout << L"Usage: dec_vp9_file --input <vp9 ivf file> --output <yuv file>" << endl;
...
ErrorCodes prepareOptions(Options &opt, int argc, wchar_t* argv[])
{
    ...
    optcfg.addOptions()
    (L"help,h", opt.help, L"")
    (L"input,i", opt.inputFile, wstring(), L"input VP9 IVF file")
