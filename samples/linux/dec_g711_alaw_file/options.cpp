...
{
    opt.inputFile = getExeDir() + "/../../assets/aud/express-dictate_8000_s8_1ch_alaw.wav";

    fs::path output(getExeDir() + "/../../output/dec_g711_alaw_file");
...
{
    cout << "dec_g711_alaw_file --input <g711 alaw wav file> --output <wav file>" << endl;
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    ...
    optcfg.addOptions()
    ("help,h", opt.help, "")
    ("input,i", opt.inputFile, string(), "input G.711 A-law WAV file")
